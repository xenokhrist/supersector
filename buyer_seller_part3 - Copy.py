...
# =============================================================================
# SIMILARITY CALCULATOR (VECTORIZED)
# =============================================================================
...
def get_top_k_recommendations(
    ...
    """
    Get top-K recommendations for a specific entity
    ...
    Returns:
        DataFrame with top-K recommendations and scores
    """
    ...
    cols = ['rank', 'similarity_score'] + [col for col in results.columns if col not in ['rank', 'similarity_score']]
    results = results[cols]
    
    return results.reset_index(drop=True)

# =============================================================================
# BULK EXPORT: ALL MATCHES ABOVE THRESHOLD
# =============================================================================
...
def export_all_matches_above_threshold(
    ...
    """
    Export all buyer-seller matches above similarity threshold
    
    Returns DataFrame with columns:
    - Buyer
    - Seller
    - Score
    - Matching_Tags (computed on-the-fly)
    - Stand_no
    ...
    st.success(f"✅ Exported {len(final_results):,} matches!")
